            ...
            <div class="row">
                <div class="col-xs-12 col-md-6 col-md-offset-3 text-center">
                    ...
                    if (
                        ...
                        !$modelProd == "" && !$marcaProd == "" && !$stockProd == "" && !$codePProd == "" && !$_FILES['img']['name'] == ""
                    ) {
                        $verificar = ejecutarSQL::consultar("select * from producto where
CodigoProd='" . $codeProd . "'");
                        $verificaltotal = mysqli_num_rows($verificar);
                        if ($verificaltotal <= 0) {
                            if (move_uploaded_file($_FILES['img']['tmp_name'], "../assets/img-
products/" . $_FILES['img']['name'])) {
                                if (consultasSQL::InsertSQL(
                                    "producto",
                                    "CodigoProd, NombreProd, CodigoCat,
Precio, Modelo, Marca, Stock, RUCProveedor, Imagen, Nombre",
                                    "'$codeProd','$nameProd','$cateProd','$priceProd',
'$modelProd','$marcaProd','$stockProd','$codePProd','" . $_FILES['img']['name'] . "','$adminProd'"
                                )) {
                                    echo '
<img src="../assets/img/correctofull.png" class="center-all-
contens">
<br>
...
La pagina se redireccionara automaticamente. Si no es asi haga
click en el siguiente boton.<br>
<a href="../configAdmin.php" class="btn btn-primary btn-lg">Volvera administración</a>
</p>';
                            }
                        } else {
                            echo '
