            ...
            <div class="contenedor-tabla pull-right">
                <div class="contenedor-tr">
                    ...
                    if (!$_SESSION['nombreAdmin'] == "") {
                        echo '<a href="configAdmin.php" class="table-cell-td">
...
';
                        ...
                        echo '<a href="pedido.php" class="table-cell-td"><i class="fa fa-table" aria-hidden="true"></i>
&nbsp;&nbsp;&nbsp;Pedido</a>
<a href="#" class="table-cell-td carrito-button-nav all-elements-tooltip" data-toggle="tooltip" data-placement="bottom" title="Ver carrito de compras">
<i class="fa fa-shopping-cart">
</i>&nbsp;&nbsp;&nbsp;Carrito
...
';
                        ...
                        echo '<a href="registration.php" class="table-cell-td"><i class="fa fa-pencil-square" aria-hidden="true"></i>
&nbsp;&nbsp;&nbsp;Registro</a>
<a href="#" class="table-cell-td carrito-button-nav all-elements-tooltip" data-toggle="tooltip" data-placement="bottom" title="Ver carrito de compras">
<i class="fa fa-shopping-cart">
</i>&nbsp;&nbsp;&nbsp;Carrito
...
<div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
    ...
    <ul class="list-unstyled text-center">
        ...
        if (!$_SESSION['nombreAdmin'] == "") {
            ...
            echo '<li><a href="pedido.php"><i class="fa fa-table" aria-hidden="true"></i>
Pedido</a></li>';
        } else {
            echo '<li><a href="registration.php"><i class="fa fa-pencil-square" aria-hidden="true"></i>
Registro</a></li>';
        }
        ?>
    </ul>
